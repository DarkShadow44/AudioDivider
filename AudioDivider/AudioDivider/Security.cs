...
namespace SoundTest_C
{
    class Security
    {
        ...
        public static void SetLowIntegrity(IntPtr handle)
        {
            ...
            if (error == 0)
                Logging.Error("'ConvertStringSecurityDescriptorToSecurityDescriptor' failed.");
            ...
            if (error == 0)
                Logging.Error("'GetSecurityDescriptorSacl' failed.");
            ...
            if (error != 0)
                Logging.Error("'SetSecurityInfo' failed.");
        }
    }
}
